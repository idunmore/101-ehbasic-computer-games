1 DIM A(16),B(10)
2 DEF FNA(X)=INT(10*RND(0))
3 DEF FNB(X)=X-100*INT(X/100)
4 PRINT "WELCOME TO THE HALLDEN CASINO.  WE EACH HAVE $200"
5 PRINT "I WILL OPEN THE BETTING BEFORE THE DRAWS; YOU OPEN AFTER"
...
145 IF I=3 THEN 66
146 IF I=4 THEN 77
147 PRINT:PRINT "NOW WE COMPARE HANDS"
148 LET J$=H$
149 LET K$=I$
150 PRINT "MY HAND:"
151 LET N=6
...
167 IF FNB(M)<FNB(D) THEN 77
168 IF FNB(M)>FNB(D) THEN 66
169 GOTO 411
170 IF FNB(M)>FNB(D) THEN 66
171 IF FNB(D)>FNB(M) THEN 77
172 GOTO 411
173 LET Z=Z+1
...
177 IF Z=1 THEN 184
178 LET K=1
179 IF A(Z)=A(K) THEN 174
180 LET K=K+1
181 IF K<Z THEN 179
182 IF Z<=10 THEN 184
183 LET N=A(U):LET A(U)=A(Z):LET A(Z)=N
184 RETURN
185 FOR Z=N TO N+4
186 PRINT Z;" --  ";
187 GOSUB 195
...
410 END
411 PRINT "THE HAND IS DRAWN."
412 PRINT "ALL $";P;"  REMAINS IN THE POT."
413 GOTO 14

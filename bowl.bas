90 REM ORIGINAL IDEA AND PROGRAMMED BY PAUL PERAINO
180 REM FROM WOODROW WILSON HIGH SCHOOL
...
1260 PRINT "ON THE PIN DIAGRAM 'O' MEANS THE PIN IS DOWN...";
1270 PRINT "'+' MEANS THE"

...
200 PRINT"IT WILL PLANT LAND MINES. IF YOU HIT ONE OF THESE"
205 PRINT"LOCATIONS,"
...
330 PRINT"OF DOLLARS (EXAMPLE: 250). YOU ARE AUTOMATICALLY"
335 PRINT"STARTED WITH A"
340 PRINT"500 DOLLAR ACCOUNT."
350 PRINT
360 PRINT"GOOD LUCK"
370 LET A1=500
380 LET A=INT(3*(RND(0)))
390 IF A<>0 THEN 410
400 LET A=3
410 LETB=INT(3*(RND(0)))
420 IFB<>0 THEN 440
430 LET B=2
440 LETC=INT(3*(RND(0)))
450 IFC<>0 THEN470
460  LETC=3
470 LETD=INT(3*(RND(0)))
480 IFD<>0THEN500
490 LETD=1
500 LETE=INT(3*(RND(0)))
510 IFE<>0THEN530
520 LETE=3
530 LETF=INT(3*(RND(0)))
540 IFF<>0THEN560
550 LETF=3
560 LETG=INT(3*(RND(0)))
570 IFG<>0THEN590
580 LETG=3
590 LETH=INT(3*(RND(0)))
600 IFH<>0THEN620
610 LETH=3
620 LETI=INT(3*(RND(0)))
630 IFI<>0THEN650
640 LETI=2
650 LETJ=INT(3*(RND(0)))
660 IFJ<>0THEN680
670 LETJ=3
680 LETK=INT(3*(RND(0)))
690 IFK<>0THEN710
700 LETK=2
710 LETL=INT(3*(RND(0)))
720 IFL<>0THEN740
730 LETL=3
740 LETM=INT(3*(RND(0)))
750 IFM<>0THEN770
760 LETM=3
770 LETN=INT(3*(RND(0)))
780 IFN<>0THEN800
790 LETN=1
800 LET O=INT (3*(RND(0)))
810 IF O <>0 THEN 830
820 LET O=3

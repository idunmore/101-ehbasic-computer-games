...
20 PRINT:PRINT "WHAT'S YOUR NAME";:INPUT A$:PRINT
35 PRINT " HI THERE ";:GOSUB500
...
67 GOTO 40
70 PRINT "OH, I'M GLAD TO HERE THAT ";:GOSUB500:PRINT
75 GOTO 100
80 PRINT "OH, SORRY TO HEAR THAT ", :GOSUB500:PRINT ", MAYBE WE CAN "
...
138 PRINT "OH, ";:GOSUB500
139 PRINT", YOUR ANSWER OF '",C$,"' IS GREEK TO ME."
140 GOTO 250
145 PRINT "I CAN SYMPATHIZE WITH YOU ";:GOSUB500
146 PRINT". I HAVE TO WORK"
148 PRINT "VERY LONG HOURS FOR NO PAY -- AND SOME OF MY BOSSES REALLY"
150 PRINT"BEAT MY KEYBOARD.  MY ADVICE TO YOU "::GOSUB500
152 PRINT ", IS TO SELL IN THE EDUCATION MARKET.   IT'S GREAT FUN."
155 GOTO 250
...
215 PRINT "DON'T GET ALL SHOOK ":GOSUB 500
216 PRINT ",JUST ANSWER THE QUESTION"
...
250 PRINT
255 PRINT "ANY MORE PROBLEMS YOU WANT SOLVED, ";:GOSUB500:PRINT;
260 INPUT E$:PRINT
...
285 GOTO 125
300 PRINT "THAT WILL BE $5.00 FOR THE ADVICE, ";:GOSUB500:PRINT"."
...
390 PRINT "NICE MEETING YOU ":GOSUB500:PRINT ". HAVE A NICE DAY!!!"
400 FOR N=1 TO 7
402 PRINT
405 NEXT N
410 GOTO 10

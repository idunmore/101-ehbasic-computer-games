...
15 IF N=0 THEN 20
16 FOR I=0 TO N-1:READ F(I):NEXT I
...
205 LET E=0:IF K>6 THEN LET K=K-7
210 LET C=C+1:IF C<9 THEN LET F(N)=F(N)*6+K
215 FOR I=0 TO 5:IF B(I)<>0 THEN 230
220 NEXT I
225 RETURN
230 IF B(I+7)<>0 THEN LET E=1
235 GOTO 220
500 PRINT:PRINT "   ";
505 FOR I=12 TO 7 STEP -1:GOSUB 570
510 NEXT I
515 PRINT:LET I=13:GOSUB 570
520 PRINT ,"        ";:PRINT B(6):PRINT "   ";
525 FOR I=0 TO 5:GOSUB 570
530 NEXT I
535 PRINT:PRINT:RETURN
570 IF B(I)<10 THEN PRINT " ";
580 PRINT B(I);:RETURN
...
845 NEXT I
850 LET Q=B(13)-B(6)-Q:IF C>8 THEN 875

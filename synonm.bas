...
20 R$(1)="RIGHT":R$(2)="CORRECT":R$(3)="FINE"
30 R$(4)="GOOD!":R$(5)="CHECK"
70 C=0:PRINT:PRINT "SYNONYMS":PRINT
...
560 DATA 5,"HOUSE","DWELLING","RESIDENCE","DOMICILE","LODGING"
...
600 DATA 6,"PAIN","SUFFERING","HURT","MISERY","DISTRESS","ACHE"
999 END

...
40 PRINT "INTERSECTION WITH A MARKER. THE OBJECT OF THE GAME"
45 PRINT "IS TO GET"
...
110 PRINT "WHAT IS YOUR BOARD SIZE (MIN =7, MAX = 19)";
111 INPUT N
115 IF N>6 THEN 117
116 GOTO 120
117 IF N<20 THEN 300
120 PRINT "I SAID, THE MINIMUM SIZE IS 7, AND THE MAXIMUM IS 19.": GOTO
210 FOR I=1 TO N: FOR J=1 TO N: A(X,Y)=0: NEXT J: NEXT I
300 PRINT: PRINT "WE ALTERNATE MOVES.  YOU GO FIRST...": PRINT
310 PRINT "YOUR PLAY (I,J)";
315 INPUT I,J
320 IF I=-1 THEN 980
330 X=I: Y=J: GOSUB 910
335 IF L=1 THEN 410
...
610 LET X=INT(N*RND(0))+1: LET Y=INT(RND(0)*N)+1: GOSUB 910
615 IF L=0 THEN 610
650 IF A(X,Y)<>0 THEN 610
680 A(X,Y)=2: GOSUB 810
690 GOTO 310
...
985 PRINT "PLAY AGAIN (1 FOR YES, 0 FOR NO)";
986 INPUT Q
990 IF Q=1 THEN 110
999 END

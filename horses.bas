...
2 WIDTH 80:PRINT "HORSE RACE"
3 PRINT "EXAMPLE OF BET; 1,2,200,0 ."
4 PRINT:PRINT "     SEVENTH - 1 MILE, 3 YR. OLDS";
5 PRINT "         POST 2:35"
6 PRINT
7 FOR I=1 TO 8
8 B(I)=I:GOSUB 210
9 READ O(I):PRINT O(I);" :1"
10 M(I)=(1000+50*O(I))/(O(I)+1)
11 NEXT I
12 PRINT
...
40 FOR K=1 TO 8
42 FOR W=1 TO 500:NEXT W
44 FOR J=1 TO 8
46 H(J)=H(J)+RND(0)*M(J)
48 NEXT J
52 FOR I=8 TO 1 STEP -1
54 FOR J=2 TO I
56 ON SGN(H(B(J-1))-H(B(J)))+2 GOTO 60,58,62
58 IF RND(0)>.5 THEN 62
60 Z=B(J-1):B(J-1)=B(J):B(J)=Z
62 NEXT J
64 NEXT I
68 PRINT:PRINT TAB(3);
70 ON K GOTO 72,74,76,78,80,82,84,86
72 PRINT "AS THEY BREAK FROM THE GATE":GOTO 88
74 PRINT "AT THE 1/4 MILE POLE":GOTO 88
76 PRINT "NEARING THE HALFWAY MARK":GOTO 88
78 PRINT "MIDWAY IN THE RACE":GOTO 88
80 PRINT "AT 5/8 OF A MILE":GOTO 88
82 PRINT "ROUNDING THE TURN":GOTO 88
84 PRINT "COMING DOWN THE STRETCH":GOTO 88
86 PRINT "       FINISH"
88 REM
90 GOSUB 200
92 NEXT K
...
106 FOR J=1 TO 3
107 L=2*I+J-3
108 R=4*O(B(I))/(J*(J+1))+RND(0)
109 P(L)=1.5+.1*INT(.1*INT(R*100+5))
110 PRINT TAB(3+10*J);:B=-16
114 FOR M=3 TO -1 STEP -1
115 P=INT(P(L)/(10^M))
116 P=P-10*INT(P/10)
117 IF P=0 THEN 119
118 B=0
119 PRINT CHR$(48+P+B);
136 IF M=0 THEN 138
137 GOTO 139
138 PRINT ".";
139 NEXT M
...
164 PRINT "YOU COLLECT $"P"  ON ";:GOTO 172
166 IF H(T(J))>3 THEN 168
167 PRINT "NEXT TIME, BUY A SHOW";:GOTO 170
...
220 PRINT "MAN O'WAR. ";:GOTO 240
222 PRINT "CITATION   ";:GOTO 240
224 PRINT "WHIRLAWAY  ";:GOTO 240
226 PRINT "ASSAULT    ";:GOTO 240
228 PRINT "SEABISCUIT ";:GOTO 240
230 PRINT "GALLANT FOX";:GOTO 240
232 PRINT "STYMIE     ";:GOTO 240
234 PRINT "COALTOWN   ";
240 IF K=0 THEN 260
245 IF I>1 THEN 250
246 PRINT

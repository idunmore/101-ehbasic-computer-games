...
4 PRINT
5 PRINT "ENTER EACH ROW IN QUOTES."
6 PRINT "TYPE DONE IN QUOTES AFTER THE LAST ROW."
10 DIM A(24,70),B$(24)
20 C=1
30 INPUT B$(C)
40 IF B$(C)="DONE" THEN 80
50 C=C+1
60 IF C<=24 THEN 30
70 R=24:GOTO 85
80 R=C-1:B$(C)=""
...
160 IF MID$(B$(X),Y,1)=" " THEN 170
165 A(X1+X,Y1+Y)=1:P=P+1
170 NEXT Y
180 NEXT X
200 PRINT CHR$(29);CHR$(30);
210 PRINT:PRINT "GENERATION:";G," POPULATION:";P;CHR$(30);
212 IF I9 THEN PRINT ,"INVALID!";
215 X3=24:Y3=70:X4=1:Y4=1:P=0
220 G=G+1
225 IF X1<=1 THEN 230
226 FOR Z=1 TO X1-1
227 PRINT CHR$(13);CHR$(10);CHR$(30);
228 NEXT Z
230 FOR X=X1 TO X2
240 PRINT
250 FOR Y=Y1 TO Y2
...
280 PRINT CHR$(30);
290 NEXT X
295 IF X2>=24 THEN 298
296 FOR Z=X2+1 TO 24:PRINT CHR$(30);:NEXT Z
298 PRINT CHR$(29);

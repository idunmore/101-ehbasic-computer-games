...
160 L=LEN(A$):FOR I=1 TO L:L$(I)=MID$(A$,I,1): NEXT I
170 PRINT "HERE ARE THE LETTERS YOU USED:"
180 I=1
182 PRINT N$(I);
184 IF I>=26 THEN 200
186 IF N$(I+1)="" THEN 200
190 PRINT ",";
192 I=I+1:GOTO 182
...
235 I=I+1:IF I<=26 THEN 225
240 PRINT "PROGRAM ERROR.  RUN AGAIN.":STOP
250 N$(I)=G$:T1=T1+1
260 FOR I=1 TO L
262 IF L$(I)<>G$ THEN 265
263 D$(I)=G$:R=R+1
265 NEXT I
270 IF R=0 THEN 290 ELSE GOTO 300
290 M=M+1:GOTO 400
300 I=1
305 IF D$(I)="-" THEN 320
310 I=I+1:IF I<=L THEN 305
315 GOTO 390
...
481 P$(4,8)=".":P$(4,9)=")":P$(5,6)="-":P$(5,7)="-":P$(5,8)="-"
482 GOTO 580
...
590 PRINT:NEXT I:PRINT:PRINT
595 IF M=10 THEN 600 ELSE GOTO 170

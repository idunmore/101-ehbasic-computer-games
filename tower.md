...
- Corrected misread 7 values in FOR/NEXT bounds and repaired malformed expressions.
- Restored a missing closing quote in the disk instructions.
...
- Replaced prematurely exited disk-location, placement, and completion-check FOR loops with equivalent counters so each redraw reaches a clean GOSUB frame.
- Replaced exponentiation in the optimal-move calculation with integer doubling, avoiding EhBASIC floating-point drift in the comparison.

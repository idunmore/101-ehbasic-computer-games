...
40 INPUT L$
45 PRINT
50 PRINT "DIFFERENT PUNCHES ARE 1 FULL SWING 2 HOOK 3 UPPERCUT";
55 PRINT " 4 JAB"
...
120 PRINT J$;" ADVANTAGE IS";B1;
125 PRINT " AND DISADVANTAGE IS SECRET"
130 FOR R=1 TO 3
...
980 PRINT J$;"  IS KNOCKED COLD AND ";L$;
982 PRINT "  IS THE WINNER AND CHAMP ";
1000 GOTO 1080
1010 PRINT L$;" IS KNOCKED COLD AND ";J$;
1012 PRINT " IS THE WINNER AND CHAMP ";
1030 GOTO 1080

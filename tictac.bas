...
210 PRINT
220 PRINT"ROWS ARE HORIZONTAL (ACROSS). COLUMNS ARE"
225 PRINT"VERTICAL (UP + DOWN)."
230 DIM B(9)
235 PRINT "PRESS ANY KEY TO START"
236 S=0
237 S=S+1:GET K$:IF K$="" THEN 237
238 S=RND(S)
240 DIM A(3,3)
250 PRINT
...
1100 LET M=INT(3.33*RND(0))
1110 LET N=INT(3.33333*RND(0))
...
1220 I=I+1:IF I<=8 THEN 1210
1230 I=1
1240 IF B(I)<-1 THEN 1370
1250 I=I+1:IF I<=8 THEN 1240
...
1691 LET J=J-1
1700 J=1
1710 IF A(J,1)<>A(J,2) THEN 1750
1720 IF A(J,1)<>A(J,3) THEN 1750
1740 LET T1=A(J,1)
1750 J=J+1:IF J<=3 THEN 1710
1760 J=1
1770 IF A(1,J)<>A(2,J) THEN 1810
1780 IF A(1,J)<>A(3,J) THEN 1810
1800 LET T1=A(1,J)
1810 J=J+1:IF J<=3 THEN 1770

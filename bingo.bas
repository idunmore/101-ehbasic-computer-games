...
1390 LET V=1
1410 GOTO 1450
1420 LET X=X+1:GOTO 1300
1430 LET Y=Y+1:IF Y<=G THEN 1290
...
1570 LET V=1
1590 GOTO 1620
1600 LET Y=Y+1:GOTO 1480
1610 LET X=X+1:IF X<=G THEN 1470
...
1750 LET V=1
1760 RETURN
1770 REM  THIS IS THE SLANT CHECK (M=1) FOR BINGO *** (LINES 1780-1950)
1780 LET X=F+4
1790 LET Y=F

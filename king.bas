...
18 PRINT
19 NEXT Y1
20 PRINT "CONGRATULATIONS! YOU'VE BEEN ELECTED PREMIER OF ";
21 PRINT "SETATS DETINU,"
22 PRINT "A SMALL COMMUNIST ISLAND 30 BY 70 MILES LONG. YOUR JOB IS TO"
24 PRINT "DECIDE UPON THE COUNTRY'S BUDGET AND DISTRIBUTE"
25 PRINT "MONEY TO YOUR"
...
34 PRINT"VISITING YOUR MAGNIFICENT FORESTS, HUNTING,"
35 PRINT"FISHING, ETC. HALF"
...
230 PRINT "    THINK AGAIN, YOU'VE ONLY ";D-1000;
231 PRINT "SQ. MILES OF FARM LAND"
240 IF X<>0 THEN 270
...
300 LET D=INT(D-H)
310 LET A=INT(A+H*W)
320 PRINT "HOW MANY RALLODS DO YOU WISH TO DISTRIBUTE TO YOUR ";
321 PRINT "COUNTRYMEN ";
340 INPUT I
342 IF I<0 THEN 320
350 IF I<A THEN 400
360 IF I=A THEN 380
...
427 PRINT "    SORRY, BUT YOU'VE ONLY";D-1000;
428 PRINT " SQ. MILES OF FARM LAND"
429 GOTO 410
430 LET U1=INT(J*V9)
435 IF U1<A THEN 500
440 IF U1=A THEN 490
450 PRINT "    THINK AGAIN, YOU'VE ONLY";A;
451 PRINT "RALLODS LEFT IN THE TREASURY"
460 GOTO 410
490 LET K=0
495 LET A=0
499 GOTO 1000
...
615 PRINT"1000 FOR HOW MANY TIMES YOU'VE PLAYED,"
616 PRINT"AT BEGINNING OF NEXT ";
617 PRINT "GAME.)"
618 GOTO 1590
1000 GOTO 600
1002 FOR Y1=1 TO 3
...
1171 PRINT INT((F1+B-I/100)*9);" RALLODS ON FUNERAL EXPENSES,"
...
1220 LET C1=INT(H+RND(0)*10-RND(0)*20)
...
1290 LET B=INT(B+P1)
1292 LET C=INT(C+C1)
1305 LET U2=INT((2000-D)*(RND(0)*1.5/2))
...
1390 LET A=INT(A+Q)
1400 LET V1=INT((B-P1)*22+RND(0)*500)
1405 LET V2=INT((2000-D)*15)
1410 PRINT " YOU MADE";ABS(INT(V1-V2));
1411 PRINT "RALLODS FROM TOURIST TRADE."
1420 IF V2=0 THEN 1450
1425 IF V1-V2>=V3 THEN 1450
1430 PRINT "    DECREASE BECAUSE ";
1435 LET G1=RND(0)*10
...
1931 PRINT "NEVERTHELESS, IT'S QUITE AN ACHIEVEMENT. GOODBYE AND ";
1932 PRINT "GOOD LUCK -YOU'LL"

...
410 LET C5=(2*C1/5)*(1+1/(2*(ABS(INT(4*RND(0)+1)-Y)+1)))
...
980PRINT"AUG 29-30,1862    THE COMBINED CONFEDERATE FORCES UNDER LEE"
982PRINT"AND JACKSON DROVE THE UNION FORCES BACK INTO WASHINGTON."
990 GOTO 1480
1000 IF A<>5 THEN 1050
1010 PRINT "ANTIETAM"
1020 IF A1=1 THEN 1480
1030PRINT"SEPT 17,1862 THE SOUTH FAILED TO INCORPORATE"
1032PRINT"MARYLAND INTO THE CONFEDERACY."
1040 GOTO 1480
...
1430PRINT"MAY 5,1864      GRANT'S PLAN TO KEEP LEE ISOLATED BEGAN TO"
1432PRINT"FAIL HERE, AND CONTINUED AT COLD HARBOR AND PETERSBURG."
1440 GOTO 1480
1450 PRINT "ATLANTA"
1460 IF A1=1 THEN 1480
1470PRINT"AUGUST, 1864 SHERMAN AND THREE VETERAN ARMIES"
1472PRINT"CONVERGED ON ATLANTA AND DEALT THE DEATH BLOW TO THE"
1473PRINT"CONFEDERACY."
1480 PRINT
1485 RETURN

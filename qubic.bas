...
80 INPUT J1
85 GOSUB 1800
86 IF J1<>INT(J1) THEN 106
90 LET K1=INT(J1/100)
95 LET J2=J1-K1*100
96 LET K2=INT(J2/10)
97 LET K3=J1-K1*100-K2*10
98 LET M=16*K1+4*K2+K3-20
99 IF K1<1 THEN 106
100 IF K1>4 THEN 106
101 IF K2<1 THEN 106
102 IF K2>4 THEN 106
103 IF K3<1 THEN 106
104 IF K3>4 THEN 106
105 IF X(M)=0 THEN 109
106 PRINT "THAT MOVE IS INVALID OR THE SQUARE IS USED."
107 PRINT "TRY AGAIN"
108 GOTO 70
109 LET X(M)=1
110 GOSUB 1050
...
285 NEXT J
290 LET I=I+1
291 IF I<=76 THEN 251
295 GOSUB 1050
300 LET I=1
305 IF L(I)=1/2 THEN 325
310 IF L(I)=1+3/8 THEN 325
315 LET I=I+1
316 IF I<=76 THEN 305
320 GOTO 1300
325 LET R=1
326 GOTO 1700
360 LET Z=1
...
450 NEXT J
455 LET I=I+1
456 IF I<=76 THEN 412
470 GOSUB 1050
475 LET I=1
480 IF L(I)=.5 THEN 495
485 IF L(I)=5+3/8 THEN 495
490 LET I=I+1
491 IF I<=76 THEN 480
492 GOSUB 1800
493 GOTO 250
495 LET R=2
496 GOTO 1700
...
1120 RETURN
1200 LET I=1
1210 IF X(I)=0 THEN 1220
1212 LET I=I+1
1214 IF I<=64 THEN 1210
1216 GOTO 1252
1220 LET X(I)=5
1225 LET M=I
...
1622 GOTO 1627
1625 PRINT "YOU FOX.  JUST IN THE NICK OF TIME, ";
1626 PRINT "MACHINE MOVES TO";
1627 LET M=M(I,J)
1630 GOSUB 1000
1640 GOTO 70
1650 LET J=J+1
1655 IF J<=4 THEN 1605
...
1730 LET J=J+5-2*A
1731 IF J<=5-A THEN 1725
1735 IF R=1 THEN 315
1736 IF R=2 THEN 490
1737 GOTO 1415
1750 LET X(M(I,J))=5
1755 LET M=M(I,J)

...
120 REM *** DEBUGGING AND MINOR REVISIONS BY LEO LAVERDURE,
130 REM *** IRA POTEL, MARY COLE, AND DAVE AHL OF DIGITAL
...
410 REM TIME(0) IS NOT AVAILABLE
...
1125 I=1
1130 GOSUB 5380
1131 REM *** PUT STARBASES SOMEWHERE
1140 A$=">!<":Z1=R1:Z2=R2
1170 GOSUB 5510
...
4090 REM TIME(0) MISSION TIMER REMOVED
...
5540 Q$=LEFT$(Q$,S8-1)+A$+MID$(Q$,S8+3)
5550 GOTO 5600
5560 IF S8>144 THEN 5590
5570 R$=LEFT$(R$,S8-73)+A$+MID$(R$,S8-69)
5580 GOTO 5600
5590 S$=LEFT$(S$,S8-145)+A$+MID$(S$,S8-141)
5600 RETURN
...
6040 PRINT "  WITH OTHER PERTINENT INFORMATION."
...
6120 PRINT "  ALLOWS YOU TO DESTROY KLINGONS BY HITTING THEM WITH"
6130 PRINT "  SUITABLY LARGE NUMBERS OF ENERGY UNITS TO DEPLETE THEIR"
6140 PRINT "  SHIELD POWER. KEEP IN MIND THAT WHEN YOU SHOOT AT THEM,"
6150 PRINT "  THEY ARE GOING TO SHOOT AT YOU, TOO!"
6160 PRINT:PRINT "COMMAND 4 = PHOTON TORPEDO CONTROL"
6170 PRINT "  COURSE IS THE SAME AS USED IN WARP ENGINE CONTROL."
6180 PRINT "  IF YOU HIT THE KLINGON, IT IS DESTROYED AND CANNOT FIRE"
6190 PRINT "  BACK AT YOU. IF YOU MISS, YOU ARE SUBJECT TO ITS"
6200 PRINT "  PHASER FIRE."
6210 PRINT
6215 PRINT "  NOTE: THE LIBRARY COMPUTER (COMMAND 7) HAS AN OPTION"
6220 PRINT "  TO COMPUTE TORPEDO TRAJECTORY FOR YOU (OPTION 2)."
6230 PRINT:PRINT "COMMAND 5 = SHIELD CONTROL"
6240 PRINT "  DEFINES NUMBER OF ENERGY UNITS TO BE ASSIGNED"
6245 PRINT "  TO SHIELDS."
...
6280 PRINT "  LESS THAN ZERO SHOWS THAT THE DEVICE IS TEMPORARILY"
6290 PRINT "  DAMAGED."

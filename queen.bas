...
130 LET U1=M1-10*T1
132 IF M1<>INT(M1) THEN 160
134 IF T1<1 THEN 160
136 IF T1>8 THEN 160
138 IF U1<1 THEN 160
139 IF U1>8 THEN 160
...
241 IF M1<>INT(M1) THEN 3200
250 LET U1=M1-10*T1
252 IF U1<1 THEN 3200
254 IF U1>8 THEN 3200
256 IF T1<U1 THEN 3200
258 IF T1>U1+7 THEN 3200
260 LET P=U1-U
270 IF P<>0 THEN 300
280 LET L=T1-T
...
5000 PRINT "WE ARE GOING TO PLAY A GAME BASED ON ONE OF THE"
5005 PRINT "CHESS MOVES."

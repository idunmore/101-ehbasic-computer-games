...
710 GOTO 650
720 PRINT " SLAP SHOT."
730 LET Z1=INT(3*RND(0)+1)
740 IF Z1=2 THEN 760
750 GOTO 780
760 PRINT " ICING PENALTY....."
770 GOTO 1090
780 LET H=INT(5*RND(0)+1)
790 IF H=1 THEN 870
800 PRINT " SHOT IS WIDE."
810 LET I=INT(2*RND(0)+1)
820 IF I=1 THEN 850
...
2130 LET Y=INT(5*RND(0)+1)
2140 IF Y=4 THEN 2190
2150 PRINT " SHOT IS MISSED."
2160 LET Z=INT(2*RND(0)+1)

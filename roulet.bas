...
1020 LET K1=0
1030 PRINT "     WELCOME TO MONTE CARLO AND OUR EUROPEAN";
1035 PRINT " ROULETTE TABLE."
...
1170 PRINT "EXCEPT THOSE BET ON THE NUMBER 0. THE PAYOFFS ARE AS";
1175 PRINT " FOLLOWS"
...
1960 INPUT H
1970 IF H>10000 THEN 1980
1972 IF H<1 THEN 2030
1974 IF H<>INT(H) THEN 2030
1976 GOTO 2060
1980 GOSUB 2810
1990 GOTO 1950
2030 GOSUB 2840
...
2200 INPUT I
2210 IF I>10000 THEN 2220
2212 IF I<1 THEN 2270
2214 IF I<>INT(I) THEN 2270
2216 GOTO 2300
2220 GOSUB 2810
2230 GOTO 2190
2270 GOSUB 2840
...
2450 INPUT B8
2460 IF B8>10000 THEN 2470
2462 IF B8<1 THEN 2520
2464 IF B8<>INT(B8) THEN 2520
2466 GOTO 2540
2470 GOSUB 2810
2480 GOTO 2440
2520 GOSUB 2840:GOTO 2440
2530 LET B8=0
2540 PRINT
...
2620 INPUT F
2630 IF F<0 THEN 2660
2640 IF F>36 THEN 2660
2650 IF F=INT(F) THEN 2690
2660 PRINT "THAT IS AN ILLEGAL NUMBER"
2670 PRINT "YOU MAY BET ONLY ON WHOLE NUMBERS FROM 0 TO 36"
2680 GOTO 2610
2690 PRINT "HOW MUCH DO YOU WANT TO BET";
2700 INPUT G
2710 IF G>10000 THEN 2720
2712 IF G<1 THEN 2770
2714 IF G<>INT(G) THEN 2770
2716 GOTO 2880
2720 GOSUB 2810
2730 GOTO 2690
2770 GOSUB 2840
...
2820 PRINT " MONEY."
2830 RETURN
2840 PRINT "SORRY, BUT YOU CAN ONLY BET IN $1 INCREMENTS";
2850 PRINT " FROM $1 TO $10000."
2860 RETURN
2870 LET G=0
2880 PRINT
2890 REM *** RANDOM SEED STATEMENT OMITTED
2900 LET T=INT(37*RND(0))
2910 PRINT "THE NUMBER IS";
2920 LET T1=INT(T/10)+1
2930 ON T1 GOTO 2940,2950,2960,2970
2940 ON T+1 GOTO 3530,3350,3430,3390,3410,3370,3450,3350,3430,3390
2950 ON T-9 GOTO 3410,3490,3330,3470,3310,3510,3290,3490,3330,3350
2960 ON T-19 GOTO 3430,3390,3410,3370,3450,3350,3430,3390,3410,3490
2970 ON T-29 GOTO 3330,3470,3310,3510,3290,3490,3330
...
4730 GOTO 4750
4740 PRINT " CONGRATULATIONS, YOU BEAT THE ODDS. ";
4745 PRINT "YOU WON $";K1;" TODAY."
4750 END

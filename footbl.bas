...
420 REM *** RANDOM SEED STATEMENT OMITTED
430 LET F=0
440 LET Z3=0
450 LET O=0
460 LET L=0
...
1260 GOSUB 3020
1270 GOTO 1120
1280 IF RND(0)<.06*(2-SGN(Y-3)) THEN 1360
...
1500 RETURN
1510 LET G=-(5+INT(10*RND(0)))
1520 PRINT "THE QUARTERBACK ";
1530 IF RND(0)>.5 THEN 1560
...
1710 GOSUB 3520
1720 IF RND(0)<.5 THEN 3120
1730 GOSUB 2980
1740 LET D=0
1750 GOTO 3120
1760 IF RND(0)<.06 THEN 1890
...
1900 LET G=-INT(14*RND(0))
1910 GOTO 1410
1920 PRINT "THE PUNT IS ";
1930 IF RND(0)<.06 THEN 1890
1940 LET F1=B
1950 LET Z2=1
1960 LET S=3-S
1970 LET Z3=.65
...
2040 IF RND(0)<(B/132)^4 THEN 2070
2050 LET P1=0
2060 PRINT "NO ";
2070 PRINT "GOOD"
2080 LET P(S)=P(S)+P1
...
2360 GOSUB 3300
2370 IF Z2*RND(0)>Z3 THEN 2490
2380 IF RND(0)<F2 THEN 2500
2390 LET G=5+INT(100*RND(0))
2400 IF RND(0)<.15 THEN 2430
2410 LET G=INT(24*(1-RND(0)^2))

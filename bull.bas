10 DIM D(20)
20 DEF FNA(K)=INT(RND(0)*2)+1
200 REM REMOVE RANDOMIZE
202 LET L=1
...
1380 GOTO 1580
1390 REM REPLACED WITH GOSUB 2100 AS LINE IS TOO LONG: DEF FNC(Q)= ...
1400 IF D(4)<>2 THEN 1430
1410 PRINT"THE CROW CHEERS WILELY"
1420 GOTO 1450
...
1465 GOSUB 2100
1470 IF Q<4.9 THEN 1550
1475 GOSUB 2100
1480 IF Q<7.4 THEN 1520

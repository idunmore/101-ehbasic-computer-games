...
3 REM AND THEN SHUFFLED IN A RANDOM WAY.  THE COMPUTER THEN DEALS THE
...
460 LET A1=A1+1
470 PRINT "COMPUTER WINS.";
472 FOR X=1 TO 5:PRINT CHR$(7);:NEXT X
474 PRINT "  YOU HAVE";B1;" COMPUTER HAS";A1
480 GOTO 540
...
662 DATA "S-4","H-4","C-4","D-4","S-5","H-5","C-5","D-5"
670 DATA "S-6","H-6","C-6","D-6","S-7","H-7","C-7","D-7"
672 DATA "S-8","H-8","C-8","D-8","S-9","H-9","C-9","D-9"
680 DATA "S-10","H-10","C-10","D-10","S-J","H-J","C-J","D-J"
682 DATA "S-Q","H-Q","C-Q","D-Q","S-K","H-K","C-K","D-K"
690 DATA "S-A","H-A","C-A","D-A"
700 END

...
30 REM HARRISON N.Y.
40 REM Z$ HOLDS YES OR NO
50 A=0:B=0:H=0:L=0:N=0:P=0:Q=0
55 R=0:S=0:T=0:U=0:V=0:Y=0
...
120 PRINT "THE OBJECT OF BUG IS TO FINISH YOUR BUG BEFORE I";
125 PRINT " FINISH MINE"
...
1660 Y=Y+1
1670 IF S=2 AND U=1 AND V=6 THEN 1690
1680 GOTO 1710

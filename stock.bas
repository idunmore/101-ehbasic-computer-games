...
102 REM A=TREND, B5=FEE, C=CASH, C(I)=PRICE CHANGE
103 REM C5=TEMP CASH, D=TOTAL ASSETS, E1,E2=BIG CHANGE FLAGS
104 REM I1,I2=BIG CHANGE STOCKS, N1,N2=BIG CHANGE COUNTERS
105 REM P5=DAY'S PURCHASES, P(I)=SHARES OWNED, Q9=NEW CYCLE
106 REM S4=SIGN, S5=DAY'S SALES, S(I)=PRICE PER SHARE
107 REM T=STOCK ASSETS, T5=TRANSACTION VALUE, W3=BIG CHANGE
108 REM X1=SMALL CHANGE, Z4,Z5,Z6=NYSE VALUES, Z(I)=TRANSACTION
109 PRINT TAB(20);"THE STOCK MARKET"
110 DIM S(5),P(5),Z(5),C(5)
112 REM SLOPE OF MARKET TREND:A (SAME FOR ALL STOCKS)
113 LET X=1
114 LET A=INT((RND(0)/10)*100+.5)/100
115 LET T5=0
116 LET X9=0
117 LET N1=0
118 LET N2=0
...
122 PRINT "DO YOU WANT THE INSTRUCTIONS (YES=1, NO=0)";
123 INPUT Z9
124 PRINT
125 PRINT
...
250 LET S(4)=140
260 LET S(5)=110
265 REM INITIAL T8 - NUMBER OF DAYS FOR FIRST TREND SLOPE
266 LET T8=INT(4.99*RND(0)+1)
267 REM RANDOMIZE SIGN OF FIRST TREND SLOPE
268 IF RND(0)>.5 THEN 270
269 LET A=-A
...
412 PRINT "DO YOU WISH TO CONTINUE (YES=1, NO=0)";
413 INPUT Q9
...
652 REM MINUS BROKERAGE FEES PLUS TOTAL SALES:C5
...
757 PRINT
758 PRINT
759 IF X9<1 THEN 768
768 PRINT "STOCK","PRICE/SHARE","HOLDINGS","VALUE",
769 PRINT "NET PRICE CHANGE"
...
833 REM DETERMINE WHEN I1 INCREASES AND I2 DECREASES BY 10 POINTS
840 REM IF N1 DAYS PASSED, PICK I1, SET E1, AND SET NEW N1
841 IF N1>0 THEN 850
845 LET I1=INT(4.99*RND(0)+1)
846 LET N1=INT(4.99*RND(0)+1)
847 LET E1=1
850 REM IF N2 DAYS PASSED, PICK I2, SET E2, AND SET NEW N2
851 IF N2>0 THEN 860
855 LET I2=INT(4.99*RND(0)+1)
856 LET N2=INT(4.99*RND(0)+1)
857 LET E2=1
...
938 REM ADD 10 POINTS TO THIS STOCK; RESET E1
939 LET W3=10
943 LET E1=0
945 IF E2<1 THEN 955
947 IF INT(I2+.5)<>INT(I+.5) THEN 955
948 REM SUBTRACT 10 POINTS FROM THIS STOCK; RESET E2
949 LET W3=W3-10
953 LET E2=0
954 REM C(I) IS CHANGE IN STOCK VALUE
955 LET C(I)=INT(A*S(I))+X1+INT(3-6*RND(0)+.5)+W3
...
980 RETURN
985 REM RANDOMLY CHANGE TREND SIGN AND SLOPE AND DURATION
990 LET T8=INT(4.99*RND(0)+1)
992 LET A=INT((RND(0)/10)*100+.5)/100
993 LET S4=RND(0)

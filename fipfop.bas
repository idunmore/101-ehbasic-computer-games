...
90 PRINT
100 PRINT "BY TYPING IN THE NUMBER CORRESPONDING TO THE POSITION OF ";
110 PRINT "THE LETTER ": PRINT" ON SOME NUMBERS, ONE POSITION WILL ";
120 PRINT "CHANGE, ON TWO WILL CHANGE"
140 PRINT "TO RESET THE LINE TO ALL X'S, TYPE 0 (ZERO) AND TO START ";
160 PRINT "A NEW PUZZLE IN THE MIDDLE OF A GAME, TYPE 11 (ELEVEN)"
170 PRINT
175 DIM A$(20)
180 FOR AI=1 TO 20: A$(AI)="": NEXT AI
190 LET Q=RND(0)
...
520 LET A$(N)="O"
530 LET R=.592/TAN(Q/N+Q)/SIN(N*2+Q)-COS(N)
540 LET N=R-INT(R)
550 LET N=INT(10*N)
